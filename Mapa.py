...
class Mapa:
    def __init__(self, jogador):
        ...
        self.__matriz = [
            ...
            [Salas.Jardim(Desafios.Quiz(texto='Qual desses tipos de planta habitou o planeta primeiro? \nBriófita, Pteridófita, Gimnosperma e Angiosperma\n', respostas=('briofta', 'briófita'))),
            Salas.Patio(),
